...
import { FaDatabase, FaCode, FaServer, FaTools, FaCloud, FaAws, FaSmile } from "react-icons/fa";
...
const skillsList = [
  ...
  { name: "Shadcn UI", icon: <SiShadcnui />, category: "frontend", level: 92 },
  ...
  { name: "HuggingFace", icon: <FaSmile />, category: "other", level: 25 },
  ...
  { name: "Docker", icon: <SiDocker />, category: "devops", level: 50 },
  { name: "AWS", icon: <FaAws />, category: "devops", level: 10 },
];
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="min-h-screen w-full flex items-center justify-center py-16 relative overflow-hidden">
