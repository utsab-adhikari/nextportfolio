...
const ApiComponent = () => {
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
      <GlobalStyles/>
        ...
        <div className="relative z-10 flex flex-col gap-6">
          ...
          >
            ...
            <p className="text-gray-300 text-base sm:text-lg max-w-xl">
              Discover the newest trends in tech, development best practices, and
              community highlights. Stay informed with what’s happening in the
              dev world.
            </p>
          </motion.div>
